...
const PrivacySection = () => {
  return (
    <div className="w-full min-h-screen mt-[70px] py-[60px] bg-gradient-to-t from-white via-[#d6d7d7] to-[#f7f8f9]">
      <div className="container mx-auto px-6 md:px-16 text-[#364146]">
        <h1 class="text-3xl font-bold mb-4 text-[#364146]">Privacy Policy</h1>
        <p class="mb-4">
          This privacy policy sets out how our website uses and protects any
          information that you give us when you use this website.
        </p>
        <h2 class="text-2xl font-bold mb-2 text-[#364146]">
        ...
        <h2 class="text-2xl font-bold mb-2 text-[#364146]">Security</h2>
        ...
        <h2 class="text-2xl font-bold mb-2 text-[#364146]">Cookies</h2>
